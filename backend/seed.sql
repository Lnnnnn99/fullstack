...
VALUES
    ("ก๋วยเตี๋ยวหมูตุ๋น", "ก๋วยเตี๋ยว", 30, "ก๋วยเตี๋ยวหมูตุ๋น.jpg", "", 1, 0, '[{"id":"size","label":"ขนาด","type":"multi-select","choices":[{"value":"special","label":"พิเศษ","price":5}]},{"id":"more","label":"เพิ่มเติม","type":"text"}]'),
    ("ก๋วยเตี๋ยวขาหมู", "ก๋วยเตี๋ยว", 30, "ก๋วยเตี๋ยวขาหมู.jpg", "", 1, 0, '[{"id":"size","label":"ขนาด","type":"multi-select","choices":[{"value":"special","label":"พิเศษ","price":5}]},{"id":"more","label":"เพิ่มเติม","type":"text"}]'),
    ("ก๋วยเตี๋ยวเย็นตาโฟ", "ก๋วยเตี๋ยว", 30, "ก๋วยเตี๋ยวเย็นตาโฟ.jpg", "", 1, 0, '[{"id":"size","label":"ขนาด","type":"multi-select","choices":[{"value":"special","label":"พิเศษ","price":5}]},{"id":"more","label":"เพิ่มเติม","type":"text"}]'),
    ("ก๋วยเตี๋ยวต้มยำ", "ก๋วยเตี๋ยว", 30, "ก๋วยเตี๋ยวต้มยำ.jpg", "", 1, 0, '[{"id":"size","label":"ขนาด","type":"multi-select","choices":[{"value":"special","label":"พิเศษ","price":5}]},{"id":"more","label":"เพิ่มเติม","type":"text"}]'),
    ("ก๋วยเตี๋ยวไก่", "ก๋วยเตี๋ยว", 30, "ก๋วยเตี๋ยวไก่.jpg", "", 1, 0, '[{"id":"size","label":"ขนาด","type":"multi-select","choices":[{"value":"special","label":"พิเศษ","price":5}]},{"id":"more","label":"เพิ่มเติม","type":"text"}]'),
    ("ข้าวขาหมู", "ข้าว", 40, "ข้าวขาหมู.jpg", "", 1, 0, '[{"id":"size","label":"ขนาด","type":"multi-select","choices":[{"value":"special","label":"พิเศษ","price":10}]},{"id":"more","label":"เพิ่มเติม","type":"text"}]'),
